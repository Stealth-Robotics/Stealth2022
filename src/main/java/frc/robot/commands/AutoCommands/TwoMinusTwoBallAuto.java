...
public class TwoMinusTwoBallAuto extends ParallelDeadlineGroup {

        static PathPlannerTrajectory twoMinusTwoBallTrajectory1 = PathPlanner.loadPath("2m2path1",
        ...
        static PathPlannerTrajectory twoMinusTwoBallTrajectory2 = PathPlanner.loadPath("2m2path2",
                        0.8 * Constants.DriveBaseConstants.MAX_VELOCITY_METERS_PER_SECOND,
                        1.0 * Constants.DriveBaseConstants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED, false);

        static PathPlannerTrajectory twoMinusTwoBallTrajectory3 = PathPlanner.loadPath("2m2path3",
                        0.8 * Constants.DriveBaseConstants.MAX_VELOCITY_METERS_PER_SECOND,
                        1.0 * Constants.DriveBaseConstants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED, false);
