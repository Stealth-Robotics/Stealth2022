...
public class TwoMinusOneBallAuto extends ParallelDeadlineGroup {

        static PathPlannerTrajectory twoMinusOneBallTrajectory1 = PathPlanner.loadPath("2m1path1",
        ...
        static PathPlannerTrajectory twoMinusOneBallTrajectory2 = PathPlanner.loadPath("2m1path2",
                        0.8 * Constants.DriveBaseConstants.MAX_VELOCITY_METERS_PER_SECOND,
                        0.1 * Constants.DriveBaseConstants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED, false);

        static PathPlannerTrajectory twoMinusOneBallTrajectory3 = PathPlanner.loadPath("2m1path3",
                        0.8 * Constants.DriveBaseConstants.MAX_VELOCITY_METERS_PER_SECOND,
                        0.1 * Constants.DriveBaseConstants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED, false);
